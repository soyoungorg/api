(function($) {
	...
	if($('.mobile-menu').length){
		...
		//Megamenu Toggle
		$('.mobile-menu .menu-box li.dropdown .dropdown-btn').on('click', function() {
	...
	//Agents Carousel Two
	if ($('.agents-carousel-two').length) {
		$('.agents-carousel-two').owlCarousel({
			animateOut: 'fadeOut',
    		animateIn: 'fadeIn',
			loop:true,
			margin:30,
	...
	//Product Tabs
	if($('.property-tab').length){
		$('.property-tab .product-tab-btns .p-tab-btn').on('click', function(e) {
			e.preventDefault();
			var target = $($(this).attr('data-tab'));
			...
			if ($(target).hasClass('actve-tab')){
				...
				$('.property-tab .product-tab-btns .p-tab-btn').removeClass('active-btn');
				$(this).addClass('active-btn');
				$('.property-tab .p-tabs-content .p-tab').removeClass('active-tab');
